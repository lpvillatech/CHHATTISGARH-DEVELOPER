...
private TextView mTextViewLuckyDay;
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message arg0) {
			 mTextViewLuckyDay.setText(getString(R.string.text_result)+" "+getLuckyDay(personName));
			return false;
		}
	});
	private String getLuckyDay(String person){
		...
		return calendar.get(Calendar.DAY_OF_MONTH)+"-"+getMonthStringByInt(calendar.get(Calendar.MONTH)+1)+"-"+calendar.get(Calendar.YEAR);
